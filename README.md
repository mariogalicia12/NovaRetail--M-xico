...
Además del análisis de negocio, el proyecto busca demostrar el uso integrado de herramientas y técnicas utilizadas en un flujo de trabajo de análisis de datos.

---

## Periodo analizado

Los datos principales del proyecto corresponden al periodo comprendido entre:
